...
{ ?>
            <div class="col-lg-4 mb-4">
                ...
                <p>
                    <abbr title="Phone">PHONE NO.: </abbr>: <?php   echo htmlentities($result->ContactNo); ?>
                </p>
                <p>
                    <abbr title="Email">EMAIL-ID:      </abbr>: <a href="mailto:name@example.com"><?php   echo htmlentities($result->EmailId); ?>
                    </a>
                </p>
              <?php }} ?>
            </div>
